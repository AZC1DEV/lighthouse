      ...
      var Customer_type = 'customer_only';
        ...
        async function report_wamas(customer_type) {
          ...
          try {
              var url = $('#base_url').val()+'dash/report/report_wamas_data/'+customer_type;
        ...
        async function dash_wamas_og002_monthly_data(month,customer_type) {
          ...
          try {
              var url = $('#base_url').val()+'dash/report/dash_wamas_og002_monthly_data/'+month+'/'+customer_type;
              const data = await fetchData(url);
              // console.log(data);
              chart_obd(data);
              // test_chart(data);
        ...
        function view_obd_order(Month,Customer_type){
          ...
          iframe = '<iframe id="iframe" src="http://122.155.175.226/lighthouse/dash/report/dash_wamas_og002_table/'+Month+'/'+Customer_type+'" height="300px" width="100%" ></iframe>'
