              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-xl-6 order-0 mb-4">
                  <div class="card h-100">
                    ...
                    <div class="card-body" >
                      <iframe src="http://122.155.175.226/lighthouse/dash/report/dash_wamas_og002_table" height="100%" width="100%" ></iframe>
                ...
                <div hidden class="col-6 col-lg-6 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between pb-0">
                      <div class="card-title mb-0">
                        <h5 class="m-0 me-2">Outbound Deliveries Order</h5>
                    ...
                    <div class="card-body">
                      ...
                      <div id="tabel_report_release" class="table-responsive"></div>
                    </div>
                  </div>
                </div>
